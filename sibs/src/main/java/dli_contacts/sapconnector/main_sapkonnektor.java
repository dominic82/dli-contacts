...
public class main_sapkonnektor {
    ...
    public static void main(String argv[]) {
        ...
        result.getSupplier().get(8).getBasicData().getCommon().getName().getFirstLineName();

        System.out.println(result.getSupplier().get(8).getBasicData().getCommon().getName().getFirstLineName());
    ...
    public static SupplierSimpleByNameAndAddressResponseMessageSync getSupplierIDs(
        ...
        SupplierSimpleByNameAndAddressQueryResponseIn bindungDaten = verbindungsObjekt.getBindingTHTTPAHTTPECCSUPPLIERSNAQRDEFAULTPROFILE();
        ...
        try {
            result = bindungDaten.supplierSimpleByNameAndAddressQueryResponseIn(lieferantAnfrage);
        } catch (StandardMessageFault e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        } catch (SOAPFaultException e) {
    ...
    public static SupplierSimpleByNameAndAddressResponseMessageSync getEmployeeIDs(
         ...
         * 
         * // Verbindung herstellen, StandardMessageFault f�r SAP notwendig try
         * { result = bindungDaten
