...
Ein weiteres Problem stellen die separaten Einzelaufrufe der Webservices für jede ID dar, siehe \ref{fig:sapbild1}. Sollten dem Benutzer keine
...
mittels der zugehörigen ID, die Adressdaten zurück, siehe \ref{fig:sapbild2}. Dadurch werden die Authentifizierungen und Datenbankzugriffe reduziert.
