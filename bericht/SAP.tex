...
müssen im Mitarbeiter Webservice erst drei Objekte der inneren Klassen erstellt werden, um im  ``innersten'' Objekt einen 
...
Authentifizierungen und Datenbankzugriffe die in keinem Verhältnis zum verwendeten Ergebnis stehen.
...
mittels der zugehörigen ID, die Adressdaten zurück. Dadurch werden die Authentifizierungen und Datenbankzugriffe reduziert.